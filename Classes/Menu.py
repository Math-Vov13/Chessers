...
#Sons
SoundGame = pygame.mixer.Sound("Sons/chess_game.mp3")   #Charge le Son du Jeu
SoundMenu = pygame.mixer.Sound("Sons/chess_menu.mp3")   #Charge le son du Menu
SoundPop = pygame.mixer.Sound("Sons/pop.mp3")           #Charge le son des boutons
...
"""
ListBoutons.append([Play_Btn, Stats_Btn, Actus_Btn]) #Ecran Menu (1)
ListBoutons.append([WhiteP_Btn, BlackP_Btn]) #Choix de la Couleur (2)
ListBoutons.append([ClassicMod_Btn, UsaVSUkMod_Btn, TimerMod_Btn, Return_Btn1]) #Choix du Mode de Jeu (3)
ListBoutons.append([StartGame_Btn, Return_Btn2]) #Commencer la Partie (4)
ListBoutons.append([]) #Partie (5)
ListBoutons.append([Continue_Btn, RMenu_Btn, Reset_Btn]) #Menu de Pause (6)
ListBoutons.append([RMenu_Btn2]) #Partie Terminée (7)"""
